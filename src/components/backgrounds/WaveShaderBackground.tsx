...
const UNIFORMS = {
  // CSS rotates the canvas 180°, so the first stop is visible at the top.
  colors: [[0.2824,0.3804,0.5529],[0.1882,0.2784,0.4157],[0.0902,0.1294,0.1882],[0.0549,0.0588,0.0588],[0.0549,0.0588,0.0588],[0.0549,0.0588,0.0588],[0.0549,0.0588,0.0588],[0.0549,0.0588,0.0588]] as [number, number, number][],
  colorCount: 4,
  scale: 1.320,
  intensity: 0.490,
  paramA: 0.840,
