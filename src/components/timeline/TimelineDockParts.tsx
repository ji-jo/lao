...
export function SkipStartIcon({ size = 14 }: { size?: number }) {
  return (
...
export function PlayTriIcon({ size = 14 }: { size?: number }) {
  return (
...
export function PauseTriIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="7" y="6" width="3.2" height="12" rx="1" fill={ICON} />
      <rect x="13.8" y="6" width="3.2" height="12" rx="1" fill={ICON} />
    </svg>
  );
}
...
export function LoopIcon({ size = 18, active = false }: { size?: number; active?: boolean }) {
  return (
    <svg width={size} height={size} viewBox="0 0 6.75 6.75" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        fill={active ? "#FFFFFF" : ICON}
      />
    </svg>
  );
}

export function ClearFrameIcon({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={{ opacity: 0.6, rotate: "90deg", transformOrigin: "50% 50%" }}
    >
      <path d="M2.549 1.203L1.695 1.724 1.304 1.084C1.162 0.849 1.237 0.538 1.472 0.396 1.707 0.254 2.017 0.328 2.16 0.563L2.549 1.203Z" transform="translate(-0.67 0.91) rotate(-15)" fill="none" stroke="#FFFFFF" strokeWidth="0.4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M3.037 2.076L2.247 2.556C1.787 2.836 1.647 3.401 1.87 3.851L2.382 4.896C2.547 5.233 2.947 5.351 3.267 5.153L4.875 4.176C5.197 3.981 5.274 3.574 5.052 3.271L4.359 2.336C4.06 1.931 3.497 1.796 3.037 2.076Z" transform="translate(-0.67 0.91) rotate(-15)" fill="none" stroke="#FFFFFF" strokeWidth="0.4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M2.771 1.06L1.49 1.841 2.01 2.695 3.291 1.914 2.771 1.06Z" transform="translate(-0.67 0.91) rotate(-15)" fill="none" stroke="#FFFFFF" strokeWidth="0.4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M3.66 3.988L4.072 4.666" transform="translate(-0.67 0.91) rotate(-15)" fill="none" stroke="#FFFFFF" strokeWidth="0.4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M3.02 4.379L3.432 5.056" transform="translate(-0.67 0.91) rotate(-15)" fill="none" stroke="#FFFFFF" strokeWidth="0.4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M4.3 3.599L4.712 4.276" transform="translate(-0.67 0.91) rotate(-15)" fill="none" stroke="#FFFFFF" strokeWidth="0.4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
 ...
 */
export function EaseCurveGlyph({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <g transform="translate(2 2)">
        <path d="M3 1H7V2H3V3H0V0H3V1Z" fill="#D9D9D9" />
        <path transform="translate(7 11)" d="M7 3H4V2H0V1H4V0H7V3Z" fill="#D9D9D9" />
        <path
 ...
 */
export function OnionRingsGlyph({ stroke = PAPER.frameActive }: { stroke?: string }) {
  return (
    <svg width={18} height={18} viewBox="122.201 122.201 18.007 18.007" xmlns="http://www.w3.org/2000/svg">
      <path fillRule="evenodd" d="M123.796 133.103C123.383 128.672 126.438 125.08 129.481 124.154C137.073 121.825 142.801 134.471 134.983 137.97C127.148 141.489 124.233 137.587 123.796 133.103Z" fill={ICON} />
...
export function LayerCountGlyph({ size = 12 }: { size?: number }) {
  return (
...
export function PaperEyeGlyph({ size = 12 }: { size?: number }) {
  return (
...
export function StagePenGlyph({ size = 12 }: { size?: number }) {
  return (
...
export function StagePreviewGlyph({ size = 12 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 4.5 4.5" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
...
export function FrameCountGlyph({ size = 12 }: { size?: number }) {
  return (
...
function StepMinus({ dim }: { dim?: boolean }) {
  return (
    <svg width={12} height={12} viewBox="0 0 4.5 4.5" style={{ opacity: dim ? 0.1 : 0.6 }}>
 ...
 * `#131313` bg, `#292A2A` 0.4px border, 6px radius, 24px tall.
 */
export function StepperBox({
  ...
  return (
    <div
      className="flex h-6 items-center gap-2 overflow-clip rounded-md px-1 py-[3px]"
      style={{ backgroundColor: PAPER.surfaceAlt, border: `0.4px solid ${PAPER.borderHairline}` }}
    >
      {leading}
      <div className="flex w-[50px] shrink-0 items-start gap-1">
        <button
          type="button"
          onClick={onDec}
        ...
        <span
          className="flex w-[18px] shrink-0 flex-wrap justify-center text-center text-[10px] leading-3 text-white tabular-nums"
...
export function DockSep() {
  return (
    <svg viewBox="116.5 116 2 18" width={2} height={18} xmlns="http://www.w3.org/2000/svg" style={{ overflow: "visible", opacity: 0.2 }} aria-hidden>
 ...
 *
 * Paper spaces these at their natural glyph size with a 10px gap, so the button
 * box IS the glyph box — the comfortable hit target comes from a transparent
 * `::before` bleeding 5px past the edges, which costs no layout.
 */
  ...
  return (
    <Tooltip content={label}>
      <button
        ...
        className={cn(
          "relative grid shrink-0 place-items-center transition-opacity before:absolute before:-inset-[5px] before:content-['']",
...
/**
 * 24×24 square button (easing / onion) — Paper 5QE-0. Idle `#161717`,
 * hover `#313131`, active `#40608E`. `children` is called with the resolved
 * background so knocked-out glyphs (onion rings) can paint their own gaps.
 */
export function SquareBtn({
  ...
  onClick?: () => void;
  active?: boolean;
  children: ReactNode | ((bg: string) => ReactNode);
}) {
  ...
  return (
    <Tooltip content={label}>
      <button
        ...
        className="relative grid h-6 w-6 shrink-0 place-items-center overflow-clip rounded-md transition-colors"
        style={{ backgroundColor: bg }}
      >
        {typeof children === "function" ? children(bg) : children}
      </button>
    </Tooltip>
  );
}
