...
const SHORTCUTS: { label: string; keys: string }[] = [
  ...
  { label: "Delete selected layers", keys: "ctrl + ⇧ + a, then del" },
  { label: "Move / path-edit whole drawing", keys: "ctrl + ⇧ + a, then v or a" },
  { label: "Copy", keys: "ctrl + c" },
  { label: "Cut", keys: "ctrl + x" },
  { label: "Paste art or text", keys: "ctrl + v" },
  { label: "Duplicate", keys: "alt + drag" },
  { label: "Send backward", keys: "[" },
  { label: "Bring forward", keys: "]" },
  { label: "Send to back", keys: "ctrl + alt + [" },
  { label: "Bring to front", keys: "ctrl + alt + ]" },
  { label: "Nudge 1px (V / A)", keys: "← ↑ → ↓" },
  { label: "Nudge 10px (V / A)", keys: "⇧ + arrow" },
